...
1. Read .ralph/progress.txt and recent git log to understand current state.
...
7. Prepend to `.ralph/progress.txt`. Use header format `## Session — YYYY-MM-DD HH:MM — Test: <module/path>` (get current date/time from the system).
